...
<body>
    <header>
        <div class="logo-container">
            <img id="male" src="./img/3.svg" alt="logo" />
            <h4 class="logo"> Dots</h4>
        </div>
        <nav>
            <ul class="nav-links">
            <li><a class="nav-link" href="#" >Specs</a></li>
            <li><a class="nav-link" href="#" >Produkty</a></li>
        ...
        <section class="presentation">
            <div class="introduction">
                <div class="intro-text">
                    <h1>Nowoczesny laptop</h1>
                    <p>The new 14 inch bezeless display offering a 4k display with touch screen</p>
                </div>
                <div class="cta">
                    <button class="cta-select">14 cali</button>
                    <button class="cta-add">do koszyka</button>
                </div>
            </div>
            <div class="cover">
